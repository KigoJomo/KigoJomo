...
![My Skills](https://skillicons.dev/icons?i=html,css,scss,tailwindcss,javascript,react,react-router,nextjs,prisma,threejs,python,django,markdown,git,github)
