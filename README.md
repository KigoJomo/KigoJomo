...
![My Skills](https://skillicons.dev/icons?i=html,css,scss,tailwindcss,javascript,npm,react,react-router,nextjs,prisma,threejs,python,django,postgres,markdown,git,github)
